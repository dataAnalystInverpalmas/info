...
$sql = "
    SELECT 
        CASE
            WHEN aa.seccion = 1 THEN 'LABORES'
            WHEN aa.seccion = 2 THEN 'APLICACIONES'
        END AS seccion,
        a.tipo,
        a.aplicar,
        a.valor,
        CASE
            WHEN pr.fecha_siembra IS NULL THEN p.fecha_siembra
            ELSE pr.fecha_siembra
        END AS fecha_siembra,
