...
<h4>Registro de Info Mensual</h4>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <!-- <div class="table-responsive"> -->        
                <table id="tableReports" class="table table-bordered table-sm display" style="width:100%" >
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <select name="tipo" id="tipod" class="form-control">
                            </select>
                        </div>
                    </div>    
                </div>             
                ...
                <div class="modal-body">
                    <form id="formOrders">
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                    <!-- <div class="table-responsive"> -->        
                                    <table id="tableReportsDetails" class="table table-bordered table-sm" style="width:100%" >
                                        <thead class="text-center">
                                            <tr>
                                                <th>Id</th>
                                                <th>order_id</th>
...
<script src="scripts/load_to_reports.js"></script>
