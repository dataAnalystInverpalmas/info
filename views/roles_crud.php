...
<div class="container-fluid" style="padding-top:20px;">
    <div class="cat-card" id="catalogCrudRoot" data-table="roles" data-endpoint="roles" data-title="CRUD Roles">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="m-0" id="catalogTitle">CRUD Roles</h4>
            <small class="text-muted" id="catalogSubtitle">Tabla roles</small>
        </div>
