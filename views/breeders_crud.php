...
<div class="container-fluid" style="padding-top:20px;">
    <div class="cat-card" id="catalogCrudRoot" data-table="breeders" data-endpoint="breeders" data-title="CRUD Breeders">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="m-0" id="catalogTitle">CRUD Breeders</h4>
            <small class="text-muted" id="catalogSubtitle">Tabla breeders</small>
        </div>
